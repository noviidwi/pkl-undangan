    ...
    <div class="container">
        ...
        <div class="couple" id="couple">
            ...
            <div class="flex-couple">
                <div class="card-couple"  data-aos-once="true">
                    <div class="character">
        ...
        <div class="event" id="event">
            ...
            <div class="grid-event">
                <div class="card-event" data-aos-once="true">
